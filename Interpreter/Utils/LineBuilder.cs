        ...
        internal static LineType  GetType (Line line)
        {
            ...
            if (firstWord != null)
            {
                if (firstWord.Token == Tokens.KEYWORD)
                {
                    ...
                    else if (firstWord.ToLower() == "endfor" || firstWord.ToLower() == "endif" || firstWord.ToLower() == "endwhile" || firstWord.ToLower() == "endsub" || firstWord.ToLower() == "endfunction" || firstWord.ToLower() == "else" || firstWord.ToLower() == "private" || firstWord.ToLower() == "break" || firstWord.ToLower() == "continue" || firstWord.ToLower() == "return")
                    {
